...
public class PetProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match){
            ...
            default:
                throw new IllegalArgumentException("Insertion is not supoorted for " + uri);
        }
    }

    private Uri insertPet(Uri uri, ContentValues values){
        Log.i("ADD_PET",uri.toString());
        ...
        if(weight != null && weight < 0){
            throw new IllegalArgumentException("Pet requires a weight or 0");
        }
